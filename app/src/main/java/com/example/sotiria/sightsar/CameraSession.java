...
public class CameraSession implements Vuforia.UpdateCallbackInterface {
    private static final String LOGTAG = "CameraSession";

    // Reference to the current activity
    private Activity mActivity;
    private CameraControl mSessionControl;
    ...
    public CameraSession(CameraControl sessionControl)
    {
    ...
    {
        CameraException vuforiaException = null;
        mActivity = activity;
        ...
        if (mInitVuforiaTask != null)
        {
            ...
            vuforiaException = new CameraException(
                    CameraException.VUFORIA_ALREADY_INITIALIZATED,
                    logMessage);
        ...
        if (vuforiaException == null)
        {
            ...
            } catch (Exception e)
            {
                ...
                vuforiaException = new CameraException(
                        CameraException.INITIALIZATION_FAILURE,
                        logMessage);
                Log.e(LOGTAG, logMessage);
            }
        }
    ...
    public void startAR(int camera) throws CameraException
    {
        String error;
        if(mCameraRunning)
        {
            ...
            throw new CameraException(
                    CameraException.CAMERA_INITIALIZATION_FAILURE, error);
        }
    ...
    public void stopAR() throws CameraException
    {
        ...
        synchronized (mShutdownLock)
        {
            ...
            if (!unloadTrackersResult)
                throw new CameraException(
                        CameraException.UNLOADING_TRACKERS_FAILURE,
                        "Failed to unload trackers\' data");

            if (!deinitTrackersResult)
                throw new CameraException(
                        CameraException.TRACKERS_DEINITIALIZATION_FAILURE,
    ...
    public void resumeAR() throws CameraException
    {
    ...
    public void pauseAR() throws CameraException
    {
        Vuforia.onPause();
        ...
        protected Boolean doInBackground(Void... params)
        {
            ...
            synchronized (mShutdownLock)
            {
                Vuforia.setInitParameters(mActivity, mVuforiaFlags,
                        "");
            ...
            if (result)
            {
                ...
                if (initTrackersResult)
                {
                    ...
                    } catch (Exception e)
                    {
                        ...
                        vuforiaException = new CameraException(
                                CameraException.LOADING_TRACKERS_FAILURE,
                                logMessage);
                        Log.e(LOGTAG, logMessage);
                        mSessionControl.onInitARDone(vuforiaException);
                    }
                ...
                {
                    vuforiaException = new CameraException(
                            CameraException.TRACKERS_INITIALIZATION_FAILURE,
    ...
    private class LoadTrackerTask extends AsyncTask<Void, Integer, Boolean>
    {
        ...
        protected void onPostExecute(Boolean result)
        {
            ...
            } else
            {
                ...
                Vuforia.registerCallback(CameraSession.this);
