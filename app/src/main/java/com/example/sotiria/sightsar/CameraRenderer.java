...
public class CameraRenderer {
    ...
    private static final String LOGTAG = CameraRenderer.class.getSimpleName();

    private RenderingPrimitives mRenderingPrimitives = null;
    private CameraRendererControl mRenderingInterface = null;
    ...
    public CameraRenderer(CameraRendererControl renderingInterface, Activity activity, int deviceMode,
                          boolean stereo, float nearPlane, float farPlane)
    {
        ...
        {
            Log.e(LOGTAG, "Devic" +
                    "e mode should be Device.MODE.MODE_AR or Device.MODE.MODE_VR");
            throw new IllegalArgumentException();
        }
    ...
    void initRendering()
    {
        vbShaderProgramID = CameraUtils.createProgramFromShaderSrc(VideoBackgroundShader.VB_VERTEX_SHADER,
    ...
    public void renderVideoBackground()
    {
        ...
        CameraUtils.checkGLError("Rendering of the video background failed");
    }
